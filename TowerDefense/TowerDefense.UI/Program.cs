...
namespace TowerDefense.UI
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            ((GameHandler)GameHandler.GetHandler()).Renderer = new RendererToViewAdapter(ViewFactory.CreateView(ViewType.NewGameView, GameHandler.GetHandler().GameEnvironment.GameInfo));
            GameHandler.GetHandler().RunGame();
