...
{
    public class InactiveStyler : Styler
    {
        public override void DrawRectangle(Graphics g, Vector2 position, Vector2 size)
        {
            g.FillRectangle(Config.InactiveBrush, (int)position.X, (int)position.Y, (int)size.X, (int)size.Y);
        ...
        {
            g.FillPath(Config.InactiveBrush, path);
